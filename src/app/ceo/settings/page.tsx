    ...
    <main>
      ...
      >
        {[
          ...
          <Link
            key={value}
            href={`/ceo/settings?section=${value}`}
            className={
              section === value
                ? "shrink-0 rounded-lg border border-violet-200 bg-violet-50 px-3 py-2.5 text-sm font-semibold text-violet-800"
                : "shrink-0 rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm font-medium hover:border-violet-300 hover:bg-violet-50"
            }
...
async function SettingsContent({ section }: { section: string }) {
  ...
  return (
    <>
        ...
        <section className="mt-6 space-y-4">
          ...
          <div>
            <article className="border border-violet-100 bg-white">
              <h3 className="border-b border-slate-200 px-5 py-4 font-heading text-lg font-semibold">
                    ...
                    >
                      ...
                      <div className="flex flex-wrap items-start gap-3 xl:justify-end">
                        <ActionButton
                          ...
                          variant={
                            foreman.isActive ? "destructive" : "secondary"
                          }
                        />
                        <details className="w-full border border-slate-200 bg-slate-50 p-3 xl:max-w-sm">
                          ...
                          >
                            ...
                            <p className="text-xs leading-5 text-slate-500">
                              Existing sessions will be signed out. Share the
      ...
      {section === "documents" ? (
        <section className="mt-6 grid overflow-hidden rounded-lg border border-slate-200 bg-white lg:grid-cols-[0.7fr_1.3fr]">
          <div className="border-b border-slate-200 bg-slate-50 p-5 lg:border-b-0 lg:border-r">
      ...
      {section === "import-template" ? (
        <section className="mt-6 flex flex-col gap-5 rounded-lg border border-slate-200 bg-white p-6 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-xs font-semibold text-slate-500">
              Data preparation
            </p>
